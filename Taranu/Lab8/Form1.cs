...
namespace Lab8
{
    public partial class Form1 : Form
    {
        ...
        // LAB 8 EX.3 stare de control iluminare pentru cea de a doua sursa de lumina 
        ...
        //# SET 2
        //LAB 8 Ex. 3 Valori alternative ambientale(lumină colorată)
        ...
        //LAB 8 Ex3 
        //Schimbăm culoarea sursei de lumină 1 (difuză) în domeniul RGB.
        ...
        //LAB 8 EX 3 
        //Schimbăm culoarea sursei de lumină 1 (specular) în domeniul RGB.
        ...
        //LAB 8 EX 3
        //Resetare stare sursă de lumină(1) nr. 1
        ...
        //LAB 8 EX 3 
        // Sursa de lumina(1) se deplaseaza folosind 6 taste.
        ...
        //LAB 8 Ex 3
        //Activăm/dezactivăm sursa 1 de iluminare (doar dacă iluminarea este activă).
        private void btnLight1_Click_1(object sender, EventArgs e)
        {
            if (lightON == true)
            {
                if (lightON_1 == false)
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            //LAB 8 EX 3 
            // Deplasare lumini folosind mouse - ul.
            if (statusControlMouse2D == true)
            {
